...
public class RepositorioFake {
	...
	public void gerarRepositorioFake(){
		//add usuario fake
				...
				//add vinculo fake
				db.execSQL("INSERT INTO vinculoUsuarioSistema(idUsuarioBiblioteca, situacao,totalEmprestimosAbertos,totalEmprestimosAtrasados,podeRealzarEmprestimos) VALUES (1234,'regular',2,0,1)");
//				//add bibliotecas fake
				...
				db.execSQL("INSERT INTO emprestimo(idUsuarioBiblioteca,codigoEmprestimo,autor,titulo, ano, dataEmprestimo, dataDevolucao, tipoEmprestimo, dataRenovacao, prazoDevolucao, biblioteca, localizacao, emAberto , codigoBarras, informacoes,renovavel) VALUES (1234,'111','Tanenbaum, Andrew S','Sistemas Operacionais Modernos','2003','2013-8-29','-','normal','-','2013-9-10','Biblioteca Setorial do CT','L2532',1,'000141','Sistemas Operacionais Modernos - Biblioteca Setorial do CT','1')");
				db.execSQL("INSERT INTO emprestimo(idUsuarioBiblioteca,codigoEmprestimo,autor,titulo, ano, dataEmprestimo, dataDevolucao, tipoEmprestimo, dataRenovacao, prazoDevolucao, biblioteca, localizacao, emAberto , codigoBarras, informacoes,renovavel) VALUES (1234,'222','Tanenbaum, Andrew S','Redes de Computadores','2005','2013-8-29','2013-8-10','normal','-','2013-8-10','Biblioteca Central','R4332',0,'222141','Redes de Computadores - Biblioteca Central','0')");
//				
				//add livro fake
